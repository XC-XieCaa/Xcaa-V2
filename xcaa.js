...
`
                 ...
                 const template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
                       templateMessage: {
                          ...
                          hydratedContentText: ${textnyaa},
                          hydratedFooterText: 'XC-XieCaa Md',
                          jpegThumbnail: fs.readFileSync('./src/foto1.jpg'),
                          hydratedButtons: [{
                          urlButton: {
...
Ketik *nyerah* untuk menyerah dan mengakui kekalahan`
                 ...
                 break
            case 'tebak': {
                 if (!xc) throw `Example : ${prefix + command} lagu\n\nOption : \n1. lagu\n2. gambar\n3. kata\n4. kalimat\n5. lirik\n6.lontong`
                 if (args[0] === "lagu") {
            ...
            case 'kuismath': case 'math': {
                 ...
                 if (!xc) throw `Mode: ${Object.keys(modes).join(' | ')}\nContoh penggunaan: ${prefix}math medium`
...
Silahkan @${m.mentionedJid[0].split`@`[0]} untuk ketik terima/tolak`
            ...
            case 'halah': case 'hilih': case 'huluh': case 'heleh': case 'holoh':
                 if (!m.quoted && !xc) throw `Kirim/reply text dengan caption ${prefix + command}`
...
//=====[ PRIMBON ]=====\\
            ...
            case 'artimimpi': case 'tafsirmimpi': {
                 if (!xc) throw `Example : ${prefix + command} belanja`
            ...
            case 'ramalanjodoh': case 'ramaljodoh': {
                 if (!xc) throw `Example : ${prefix + command} Pinky, 7, 7, 2005, Novia, 16, 11, 2004`
            ...
            case 'ramalancinta': case 'ramalcinta': {
                 ...
                 break
            case 'artinama': {
                 if (!xc) throw `Example : ${prefix + command} Pinky Ardianta`
            ...
            case 'kecocokannama': case 'cocoknama': {
                 if (!xc) throw `Example : ${prefix + command} Pinky, 7, 7, 2005`
            ...
            case 'kecocokanpasangan': case 'cocokpasangan': case 'pasangan': {
                 if (!xc) throw `Example : ${prefix + command} Pinky|Novia`
            ...
            case 'jadianpernikahan': case 'jadiannikah': {
                 if (!xc) throw `Example : ${prefix + command} 6, 12, 2020`
            ...
            case 'rejeki': case 'rezeki': {
                 if (!xc) throw `Example : ${prefix + command} 7, 7, 2005`
                 let [tgl, bln, thn] = text.split`,`
            ...
            case 'artitarot': case 'tarot': {
                 ...
                 break
            case 'fengshui': {
                 if (!xc) throw `Example : ${prefix + command} Pinky, 1, 2005\n\nNote : ${prefix + command} Nama, gender, tahun lahir\nGender : 1 untuk laki-laki & 2 untuk perempuan`
            ...
            case 'arahrejeki': case 'arahrezeki': {
                 ...
                 break
            case 'peruntungan': {
                 if (!xc) throw `Example : ${prefix + command} Pinky, 7, 7, 2005, 2022\n\nNote : ${prefix + command} Nama, tanggal lahir, bulan lahir, tahun lahir, untuk tahun`
            ...
            case 'keberuntungan': {
                 ...
                 break
            case 'memancing': {
                 if (!xc) throw `Example : ${prefix + command} 12, 1, 2022`
                 let [tgl, bln, thn] = text.split`,`
                 ...
                 break
            case 'masasubur': {
                 if (!xc) throw `Example : ${prefix + command} 12, 1, 2022, 28\n\nNote : ${prefix + command} hari pertama menstruasi, siklus`
            ...
            case 'zodiak': case 'zodiac': {
                 ...
                 break
            case 'shio': {
                 if (!xc) throw `Example : ${prefix + command} tikus\n\nNote : For Detail https://primbon.com/shio.htm`
...
//=====[ SEARCH ]=====\\
            ...
            case 'play': case 'ytplay': {
                 if (!text) throw `Example : ${prefix + command} Lagu Wibu`
                 let yts = require("yt-search")
                 let search = await yts(text)
...
let teks = `══✪〘 *TAG ALL* 〙✪══
 ...
 ➲ *Pesan : ${q ? q : 'kosong'}*\n\n`
            ...
            case 'ephemeral': {
                 ...
                 if (!isBotAdmins) throw mess.botAdmin
                 if (!isGroupAdmins && !isGroupOwner) throw mess.admin
                 if (!xc) throw 'Masukkan value enable/disable'
                 if (args[0] === 'enable') {
...
//=====[ CONVERTER ]=====\\
            case 'sticker': case 's': case 'stickergif': case 'sgif': {
                 ...
                 break
            case 'ebinary': {
                 if (!m.quoted.text && !xc) throw `Kirim/reply text dengan caption ${prefix + command}`
            ...
            case 'dbinary': {
                 ...
                 break
            case 'emojimix': {
	             if (!xc) throw `Example : ${prefix + command} 😅+🤔`
...
`.trim()
            ...
            case 'addmsg': {
                 ...
                 if (!xc) throw `Example : ${prefix + command} nama file`
...
Lihat list Pesan Dengan ${prefix}listmsg`)
                 ...
                 break
            case 'getmsg': {
                 if (!xc) throw `Example : ${prefix + command} file name\n\nLihat list pesan dengan ${prefix}listmsg`
                 let msgs = JSON.parse(fs.readFileSync('./database/data.json'))
...
//=====[ OWNER ]=====\\
            ...
            case 'join': {
                 if (!isCreator) throw mess.owner
                 if (!xc) throw 'Masukkan Link Group!'
